...
<body>
    <div class="container mt-4 pt-4">
        ...
        <?php } ?>
        <!-- Card Login -->
        <div class="card shadow-lg mt-5 mb-5" style="border-radius:20px;">
            <div class="card-body">
                ...
                <form action="register.php" method="post">
                    ...
                    <div class="mb-4" style="text-align: center;">
                        <button type="submit" class="mb-4" name="submit">Sign Up</button>
                        <div class="link">Have an account? <a class="text-decoration-none" href="login.php">Log In</a></div>
                    </div>
                </form>
           </div>
        </div>
